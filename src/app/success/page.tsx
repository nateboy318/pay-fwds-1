  ...
  const handleShare = (platform: 'facebook' | 'google') => {
    ...
    if (platform === 'facebook') {
      ...
      navigator.clipboard.writeText(generatedReview).then(() => {
        ...
        window.open(`https://www.google.com/search?q=payfwds&oq=payfwds&gs_lcrp=EgZjaHJvbWUqDAgAECMYJxiABBiKBTIMCAAQIxgnGIAEGIoFMg0IARAuGK8BGMcBGIAEMgYIAhBFGEAyCggDEAAYgAQYogQyCggEEAAYgAQYogQyBggFEEUYPDIGCAYQRRg8MgYIBxBFGDzSAQg1NDQxajFqN6gCALACAA&sourceid=chrome&ie=UTF-8#lrd=0x8869992f3f6ae381:0x7195f1f2040cfac3,3,,,,`, '_blank');
      }).catch(err => {
  ...
  return (
    <div className="min-h-screen bg-white p-4 sm:p-8 flex items-center justify-center">
      <main className="max-w-xl w-full text-center">
        <h1 className="text-4xl sm:text-3xl font-bold mb-4 sm:mb-6 text-gray-800">Thank You for Your Feedback!</h1>
        <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8">We've built a review for you. Just click once and review us on Facebook or Google in less than 30 seconds.</p>
